 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |Symbol|   A  |   O  |   E  |   U  |   I  |   D  |   H  |   T  |   N  |   S  |  -   |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | Shift|   ;  |   Q  |   J  |   K  |   X  |   B  |   M  |   W  |   V  |   Z  |Shift |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Media | Ctrl | Alt  | GUI  |Lower |Space |Space |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_DVORAK] = LAYOUT_ortho_4x12( \
  KC_TAB,  KC_QUOT, KC_COMM, KC_DOT,  KC_P,    KC_Y,    KC_F,    KC_G,    KC_C,    KC_R,    KC_L,    KC_BSPC, \
  SYMBOL,  KC_A,    KC_O,    KC_E,    KC_U,    KC_I,    KC_D,    KC_H,    KC_T,    KC_N,    KC_S,    KC_MINS, \
  KC_LSFT, KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X,    KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,    KC_RSFT ,\
  MEDIA ,  KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
...
[_LOWER] = LAYOUT_ortho_4x12( \
  KC_ESC , _______, PREV_TAB, _______, NEXT_TAB, _______, _______, _______, KC_UP  , _______, _______, _______, \
  _______, _______, _______, CMD_TAB, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______, \
...
[_RAISE] = LAYOUT_ortho_4x12( \
  KC_GRAVE, KC_1  , KC_2   , KC_3   , _______, _______, _______, _______, _______, _______, _______, _______, \
 ...
 */
 [_SYMBOL] = LAYOUT_ortho_4x12( \
  KC_GRAVE,KC_EXLM, KC_AT  , KC_HASH, KC_DLR , KC_PERC, KC_CIRC, KC_AMPR, KC_PAST, KC_LPRN, KC_RPRN, KC_EQUAL, \
  _______, _______, _______, _______, ALFRED , _______, _______, KC_SLSH, KC_QUES, KC_LCBR, KC_RCBR, KC_PLUS, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, KC_PIPE, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_TILD, _______, KC_BSLS \
),
